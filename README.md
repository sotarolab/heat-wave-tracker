...
- **Live verification** — a running scorecard of bias, RMSE, and a
  Brier score (the standard scoring rule for probabilistic weather
  forecasts) comparing the day's forecast against what actually
...
- **Historical extreme-value analysis** — each station's forecast is
  ...
  Generalized Extreme Value (GEV) fit, the same class of model behind
  NOAA's official return-period products, answering "how rare is this,
